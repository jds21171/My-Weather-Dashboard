...
function success(position) {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&APPID=1a0fd8b4bdb1eea0f393d15e343cd86d";
    $.ajax({
        url: queryURL,
        method: "GET"
...
function getCurrent(city) {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=1a0fd8b4bdb1eea0f393d15e343cd86d&units=imperial";
    $.ajax({
        url: queryURL,
        method: "GET",
        error: function (){
        ...
        //get UV Index
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=1a0fd8b4bdb1eea0f393d15e343cd86d&lat=" + response.coord.lat + "&lon=" + response.coord.lat;
        $.ajax({
            url: uvURL,
            method: "GET"
...
function getForecast(city) {
    //get 5 day forecast
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?id=" + city + "&APPID=1a0fd8b4bdb1eea0f393d15e343cd86d&units=imperial";
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (response) {
